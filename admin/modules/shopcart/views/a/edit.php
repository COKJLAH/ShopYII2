...
<h4 class="text-right"><?= Yii::t('admin/shopcart', 'Стоимость {goods_total_count} товара(ов):', ['goods_total_count' => $goods_total_count]) ?> <?= $order->cost ?></h4>
...
<div class="row">
    <div class="col-md-12">
        ...
        <hr>
        <?= $order->delivery_details ?> - <?= $order->delivery_cost ?> </i>        
    </div>    
</div>
<div class="row">
    <div class="col-md-12 text-right">
        <h3><?= Yii::t('admin/shopcart', 'Итого стоимость заказа: ') ?> <?= $order->totalCost ?> Грн</h3>
    </div>
</div>
