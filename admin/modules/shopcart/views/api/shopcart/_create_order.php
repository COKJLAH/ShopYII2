...
if (count($deliveries)) {
                                ...
                                <div class="radio">
                                    <label for="delivery_<?= $delivery->id ?>">
                                        <input type="radio" name="delivery_id" class="shopcart_delivery_radio" id="delivery_<?= $delivery->id ?>"
                                               ...
                                               ?>>
                                        <?= $delivery->title ?> - <?= $free_delivery ? '<del class="text-muted"><small>' . $delivery->price . '</small></del> 0 Грн' : $delivery->price ?>
                                        

                                        <? if ($delivery->free_from > 0) {
                                            ?>
                                            (<?= Yii::t('admin/shopcart', "бесплатно при стоимости заказа от "); ?> <?= $delivery->free_from; ?> Грн</i>)
                                        <? } ?>                                        
                                    </label>
    ...
    <div class="row">
        <div class="col-md-12 text-right">
            <h3><?= Yii::t('admin/shopcart', 'Итого стоимость заказа: ') ?> <span id="shopcart_total_cost"><?= Shopcart::cost() + $delivery_price ?> Грн</span></h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-7">
