                ...
                <tbody>
                    ...
                    foreach ($goods as $good) :
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= $good->price * $good->count ?> Грн</td>
                    ...
                    <tr>
                        <td colspan="6" class="text-right">
                            <h4><?= Yii::t('admin/shopcart', 'Стоимость {goods_total_count} товара(ов):', ['goods_total_count' => $goods_total_count]) ?> <?= Shopcart::cost() ?> Грн </h4>                            
                        </td>
                    </tr>
                </tbody>
            </table>
