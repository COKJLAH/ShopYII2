    ...
    <tbody>
        ...
        foreach ($order->goods as $good) :
            ...
            <tr>
                ...
                <td><?= $good->price * $good->count ?> Грн</td>
            </tr>
        <? endforeach; ?>
        <tr>
            <td colspan="5" class="text-right">
                <h4><?= Yii::t('admin/shopcart', 'Стоимость {goods_total_count} товара(ов):', ['goods_total_count' => $goods_total_count]) ?> <?= $order->cost ?> Грн</h4>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <div class="col-md-4">
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td>
<?= $order->deliveryDetails ?> - <?= $order->deliveryCost ?> Грн
                    </td>            
                </tr>                    
            </tbody>
        </table> 
...
<div class="row">
    <div class="col-md-12 text-right">
        <h4><?= Yii::t('admin/shopcart', 'ИТОГО стоимость заказа (с учетом доставки): ') ?> <?= $order->totalCost ?> Грн</h4>
        <br>
